...
class EEGNet(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = nn.Conv2d(1, F1, (1, kernel_1_size), padding=(0, kernel_1_size // 2), bias=False)
        ...
        self.separable_conv = nn.Conv2d(F1 * D, F2, (1, kernel_2_size), padding=(0, kernel_2_size // 2), bias=False)
        self.bn3 = nn.BatchNorm2d(F2)
        self.avg_pool2 = nn.AvgPool2d((1, 8))
        self.dropout2 = nn.Dropout(p=dropout_rate)
        
        # Fully Connected Layer
        # The flattened size calculation depends on the output of the last pooling layer.
        ...
        # After pool2 (stride 8): 125 / 8 = 15.625 -> 15
